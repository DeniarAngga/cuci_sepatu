...
<body>
            ...
            <div class="col-sm-6 text-sm-end">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">FAST CLEANING</li>
                    </ol>
                </nav>                
            </div>
        </div>
    ...
    <div class="center-image">
        <img src="user/img/fastcleaning.png" alt="Diagram Sepatu">
    </div>
    <div class="container">
        <div class="left-section">
            <h2>KETERANGAN LAYANAN</h2>
            <ul>
                <li>Treatment membersihkan / cuci sepatu secara cepat khusus untuk sepatu (lebih dikhususkan <i>sneakers</i>/<i>loafers</i>) aman untuk semua bahan dan warna.</li>
                ...
                <li>Bagian yang di-treatment: <span class="bold">upper, midsole</span></li>
                <li>Durasi pengerjaan ± 45 menit. (Silahkan konfirmasi lagi ke workshop)</li>
            </ul>
            <h3>NOTE:</h3>
            <ul>
            ...
            <h3 style="margin-top: 50px;"><span class="bold"> HASIL FAST CLEANING</span></li></h3>
            <div class="gallery">
                <img src="user/img/hasil_fc1.jpg" alt="Before After 1">
                <img src="user/img/hasil_fc2.jpg" alt="Before After 2">
                <img src="user/img/hasil_fc3.jpg" alt="Before After 3">
            </div>
        </div>
    </div>
    <div class="features">
