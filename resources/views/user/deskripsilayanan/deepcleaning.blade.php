...
<body>
            ...
            <div class="col-sm-6 text-sm-end">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">DEEP CLEAN</li>
                    </ol>
                </nav>                
            </div>
        </div>
    ...
    <div class="center-image">
        <img src="user/img/deepcleaning.png" alt="Diagram Sepatu">
    </div>
    <div class="container">
        <div class="left-section">
            <h2>KETERANGAN LAYANAN</h2>
            <ul>
                <li>Treatment pencucian khusus untuk sepatu secara detail untuk seluruh bagian, aman untuk semua bahan dan warna.</li>
                ...
                <li>Bagian yang di-treatment: <span class="bold">upper, midsole, outsole, insole, laces</span></li>
            ...
            <h3 style="margin-top: 50px;"><span class="bold"> HASIL DEEP CLEANING</span></li></h3>
            <div class="gallery">
                <img src="user/img/hasil_dc1.jpg" alt="Before After 1">
                <img src="user/img/hasil_dc2.jpg" alt="Before After 2">
                <img src="user/img/hasil_dc3.jpg" alt="Before After 3">
            </div>
        </div>
    </div>
    <div class="features">
