...
<body>
            ...
            <div class="col-sm-6 text-sm-end">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">WHITENING</li>
                    </ol>
                </nav>                
            </div>
        </div>
    ...
    <div class="center-image">
        <img src="user/img/unyellowing.png" alt="Diagram Sepatu">
    </div>
    <div class="container">
        <div class="left-section">
            <h2>KETERANGAN LAYANAN</h2>
            <ul>
                <li>Treatment pencucian khusus untuk sepatu berbahan canvas dan mesh berwarna putih.</li>
                <li>Baik untuk membersihkan noda hitam atau menghilangkan noda menguning pada upper sepatu berwarna putih ataupun warna terang.</li>
                <li>Dilakukan secara manual sehingga aman untuk semua jenis sepatu.</li>
                <li>Bagian yang di-treatment: <span class="bold"> upper</span></li>
                <li>Durasi pengerjaan +- 3 hari.(Silahkan konfirmasi lagi ke workshop)</li>
            </ul>
            <h3>NOTE:</h3>
            <ul>
                <li>Jangan biarkan noda melekat terlalu lama dan merusak bahan dari sepatu kesayanganmu.</li>
                <LI>Untuk hasil yang maksimal, dapat menambahkan treatment DeepClean.</li>
                <li>Jangan lupa untuk <b>Follow IG</b> kita untuk mendapatkan info promo-promo menarik untuk anda.</li>
            </ul>
            <h3 style="margin-top: 50px;"><span class="bold"> HASIL WHITENING</span></li></h3>
            <div class="gallery">
                <img src="user/img/hasil_wt1.jpg" alt="Before After 1">
                <img src="user/img/hasil_wt2.jpg" alt="Before After 2">
                <img src="user/img/hasil_wt3.jpg" alt="Before After 3">
            </div>
        </div>
    </div>
    <div class="features">
