...
<body>
            ...
            <div class="col-sm-6 text-sm-end">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">REPAINT KHUSUS</li>
                    </ol>
                </nav>                
            </div>
        </div>
    ...
    <div class="center-image">
        <img src="user/img/repaintkhusus.png" alt="Diagram Sepatu">
    </div>
    <div class="container">
        <div class="left-section">
            <h2>KETERANGAN LAYANAN</h2>
            <ul>
                <li>Treatment pewarnaan khusus untuk sepatu berbahan suede,leather/kulit, solusi untuk mencerahkan warna yang pudar atau mulai kusam.</li>
                ...
                <li>Bagian yang di-treatment: <span class="bold"> paket komplit</span></li>
            ...
            <h3 style="margin-top: 50px;"><span class="bold"> HASIL REPAINT KHUSUS</span></li></h3>
            <div class="gallery">
                <img src="user/img/hasil_rk1.jpg" alt="Before After 1">
                <img src="user/img/hasil_rk2.jpg" alt="Before After 2">
                <img src="user/img/hasil_rk3.jpg" alt="Before After 3">
            </div>
        </div>
    </div>
    <div class="features">
