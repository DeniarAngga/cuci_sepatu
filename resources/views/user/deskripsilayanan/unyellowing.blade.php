...
<body>
            ...
            <div class="col-sm-6 text-sm-end">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">UNYELLOWING</li>
                    </ol>
                </nav>                
            </div>
        </div>
    ...
    <div class="container">
        <div class="left-section">
            ...
            <ul>
                <li>Treatment layanan khusus untuk midsole sepatu yang yellowing, aman untuk bahan rubber/karet.</li>
                <li>Menggunakan bahan kimia khusus untuk mengoksidasi midsole sepatu.</li>
                <li>Perlakuan treatment hanya dilakukan maksimal 2x.</li>
                <li>Bagian yang di-treatment: <span class="bold"> midsole rubber(karet)</span></li>
            ...
            <h3 style="margin-top: 50px;"><span class="bold"> HASIL UNYELLOWING</span></li></h3>
            <div class="gallery">
                <img src="user/img/hasil_uny1.jpg" alt="Before After 1">
                <img src="user/img/hasil_uny2.jpg" alt="Before After 2">
                <img src="user/img/hasil_uny3.jpg" alt="Before After 3">
            </div>
        </div>
    </div>
    <div class="features">
