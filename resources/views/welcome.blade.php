<html lang="en">
 ...
 @include('layoutsuser.navbar')
  ...
  <div class="container hero-section mt-5">
   ...
   <img alt="Group of people holding up various types of shoes" height="400" src="user/img/tampilanhome1.png" width="300"/>
  </div>
  <div class="container about-section">
   ...
   <p>
    Denshoes adalah sebuah website yang bisa digunakan untuk memesan jasa layanan cuci sepatu online. Dengan memanfaatkan teknologi yang ada, kalian bisa langsung memesan jasa hanya dengan melalui telepon genggam saja.
   </p>
   <p>
    Kami berharap dengan adanya website ini dapat memberikan solusi, terlebih untuk kalian yang ingin menjaga sepatu tetap bagus dan bersih seperti pertama kali beli.
   </p>
  </div>
   ...
   <div class="row">
    <div class="col-md-4">
     <div class="service-card">
      <img alt="Fast Cleaning service illustration" height="100" src="user/img/fastcleaning.png" width="100"/>
      <h4>
       FAST CLEANING
      </h4>
      <p>
    ...
    <div class="col-md-4">
     <div class="service-card">
      <img alt="Whitening service illustration" height="100" src="user/img/whitening.png" width="100"/>
      <h4>
       WHITENING
      </h4>
      <p>
       Treatment pencucian khusus untuk sepatu berbahan canvas dan mesh berwarna putih dengan noda kuning ataupun saus
      </p>
     </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
     <div class="service-card">
      <img alt="Repaint Khusus service illustration" height="100" src="user/img/repaintkhusus.png" width="100"/>
      <h4>
       REPAINT KHUSUS
      </h4>
      <p>
    ...
    <div class="col-md-4">
     <div class="service-card">
      <img alt="Pickup Services illustration" height="100" src="user/img/pickupservice.png" width="100"/>
      <h4>
       PICKUP SERVICES
      </h4>
      <p>
